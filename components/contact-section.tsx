  ...
  return (
    <section ref={ref} id="contact" className="relative mx-auto max-w-5xl px-6 py-32">
      ...
      >
        ...
        <p className="mb-12 max-w-xl text-base sm:text-lg leading-relaxed text-muted-foreground">
        ...
        <div className="grid gap-8 lg:grid-cols-2">
          ...
          <div className="flex flex-col items-center justify-center gap-6 lg:items-start lg:justify-start">
            <h3 className="text-lg font-semibold text-foreground lg:text-base lg:font-medium lg:text-muted-foreground">Or reach out via:</h3>
            ...
            <div className="flex items-center gap-6 lg:hidden">
              <a
                ...
                aria-label="Email"
              >
                <svg width="32" height="32" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round" className="text-foreground transition-all duration-300 group-hover:scale-110 group-hover:text-primary group-hover:drop-shadow-[0_0_12px_rgba(45,212,191,0.5)]">
                  <rect x="2" y="4" width="20" height="16" rx="2" />
                  <path d="m22 7-8.97 5.7a1.94 1.94 0 0 1-2.06 0L2 7" />
                </svg>
                <span className="text-xs font-medium text-muted-foreground group-hover:text-primary transition-colors duration-300">Email</span>
              </a>
              <a
              ...
              >
                ...
                <span className="text-xs font-medium text-muted-foreground group-hover:text-primary transition-colors duration-300">LinkedIn</span>
              </a>
              <a
              ...
              >
                ...
                <span className="text-xs font-medium text-muted-foreground group-hover:text-primary transition-colors duration-300">GitHub</span>
              </a>
            </div>
